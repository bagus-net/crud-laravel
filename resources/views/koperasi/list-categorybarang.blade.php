 ...
 <div class="row">
        <div class="col-lg-12 margin-tb">
             <div class="card">
                <div class="card-body">
                {{-- @can('product-create') --}}
                <a class="btn btn-success" href="{{ route('koperasicategorybarang.create') }}"> Add Category</a>
                {{-- @endcan --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('koperasicategorybarang.destroy',$item->id) }}" method="POST">
                                    ...
                                    {{-- @endcan --}}
                                    <a class="btn btn-danger" href="{{ route('koperasicategorybarang.destroy',$item->id) }}">Delete</a>
