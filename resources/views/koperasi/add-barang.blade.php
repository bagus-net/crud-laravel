    ...
    <form action="{{ route('koperasibarang.add') }}" method="POST">
    	@csrf
            ...
            <div class="mb-3 row">
              ...
              <div class="col-md-10">
              <input class="form-control" type="text" name="barang" value="" id="example-text-input" placeholder="barang">
              </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-10">
            <input class="form-control" type="text" name="price" value="" id="example-text-input" placeholder="price">
            </div>
        </div>
